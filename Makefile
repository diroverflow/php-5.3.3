...
EXTRA_LIBS = -lcrypt -lresolv -lcrypt -lm -ldl -lnsl -lxml2 -lcrypt -lcrypt -lz
ZEND_EXTRA_LIBS =
INCLUDES = -I/root/php-5.3.3/ext/date/lib -I/root/php-5.3.3/ext/ereg/regex -I/usr/include/libxml2 -I$(top_builddir)/TSRM -I$(top_builddir)/Zend
EXTRA_INCLUDES =
INCLUDE_PATH = .:
